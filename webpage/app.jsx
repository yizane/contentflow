  ...
  return (
    <div style={{ height: "100vh", display: "grid", placeItems: "center" }}>
      <div style={{ textAlign: "center", maxWidth: 420 }}>
        ...
        <p style={{ color: "var(--ink-3)", fontSize: 13, lineHeight: 1.6, margin: "0 0 16px" }}>{String(error && error.message || error)}<br />请确认已运行 <code className="mono">npm run viewer</code> 且 MySQL 可达。</p>
